  ...
  return (
    ...
    >
      <div className="relative aspect-square bg-ink-100">
        ...
        {discount && (
          <span className="absolute left-2 top-2 rounded-full bg-enkays-600 px-2 py-1 text-xs font-semibold text-white">
            -{discount}%
          </span>
        )}
      </div>
      ...
      <div className="flex flex-1 flex-col gap-1 p-3">
        {product.category && (
          <p className="text-[10px] font-bold uppercase tracking-wider text-enkays-600">
