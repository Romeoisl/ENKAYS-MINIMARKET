...
async function main() {
  ...
  await prisma.siteSettings.upsert({
    where: { id: 1 }, update: {}, create: {
      ...
      defaultWhatsAppMessage: "Hello, I’m interested in ordering from ENKAYS MINI-MARKETPLACE.", orderPrefix: "ENK",
    },
  });
  ...
  await prisma.productVariant.createMany({ data: [
    { productId: headphones.id, name: "Color", value: "Black", sku: "WH-001-BLK", price: 4500000, stock: 10, options: { color: "Black" } },
    { productId: headphones.id, name: "Color", value: "Silver", sku: "WH-001-SLV", price: 4700000, stock: 8, options: { color: "Silver" } },
  ] });
  ...
  await prisma.deliveryZone.upsert({ where: { id: "demo-abuja" }, update: {}, create: { id: "demo-abuja", state: "FCT", city: "Abuja", zone: "Demo Zone", fee: 250000, estimatedDelivery: "1–3 business days", freeDeliveryThreshold: 10000000, pickup: true, active: true } });
